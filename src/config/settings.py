...
_DEFAULTS: dict[str, Any] = {
    "llm": {
        ...
        "fallbacks": {},
        "role_options": {
            "database_engineer": {"num_predict": 2048, "temperature": 0.1},
            "api_integration_engineer": {"num_predict": 2048, "temperature": 0.1},
            "frontend_developer": {"num_predict": 2048, "temperature": 0.1},
            "backend_developer": {"num_predict": 2048, "temperature": 0.1},
            "data_analytics_engineer": {"num_predict": 1536, "temperature": 0.1},
            "performance_engineer": {"num_predict": 1024, "temperature": 0.1},
            "security_engineer": {"num_predict": 1024, "temperature": 0.1},
            "qa_engineer": {"num_predict": 1536, "temperature": 0.1},
            ...
            "devops_engineer": {"num_predict": 1536, "temperature": 0.2},
        },
        "role_retries": {},
    },
    "agents": {
    ...
    "crew": {
        ...
        # Disabled by default – require explicit opt-in on capable hardware
    ...
    "skills": {
        ...
        "packs": {
            "ecc": {
                "enabled": False,  # BUG FIX: disabled by default to prevent prompt bloat
                "profile": "starter",
            }
        },
        "shared": [
...
def _validate_config(cfg: dict[str, Any]) -> None:
    ...
    for role, r in role_retries.items():
        if known_roles and role not in known_roles:
            raise ValueError(
...
def _apply_env_overrides(cfg: dict[str, Any]) -> None:
    ...
    base_url = _str("OLLAMA_BASE_URL") or _str("OLLAMA_URL")
