...
ECC_CANONICAL_SKILLS: dict[str, CanonicalSkill] = {
    ...
    "docker_patterns": CanonicalSkill(
        ...
        category="operations",
        recommended_roles=("devops_engineer", "sre_reliability_engineer", "backend_developer"),
        priority=1,
    ),
    ...
    "postgres_patterns": CanonicalSkill(
        ...
        category="data",
        recommended_roles=("architect", "database_engineer", "backend_developer", "code_reviewer"),
        priority=2,
    ),
    ...
    "tdd_workflow": CanonicalSkill(
        ...
        category="testing",
        recommended_roles=("backend_developer", "api_integration_engineer", "qa_engineer"),
        priority=1,
    ),
    ...
    "terminal_ops": CanonicalSkill(
        ...
        category="operations",
        recommended_roles=("backend_developer", "sre_reliability_engineer", "devops_engineer"),
        priority=3,
    ),
