...
TASKS: dict[str, Task] = {
    "ceo_planner": Task(
        ...
        description=(
            ...
            "- Base every claim ONLY on information present in the requirements above.\n"
            "- Do NOT invent facts, assume unrelated industries, or drift into unrelated topics.\n"
            "- If information is missing or ambiguous, list it explicitly as an Open Question.\n"
            "- Stay strictly within the problem domain described in the requirements.\n\n"
            ...
            "Include an **Implementation Blueprint** section in your handoff_notes with:\n"
            "- Proposed repository structure (top-level directories and their purpose)\n"
            "- Key modules / services and their responsibilities\n"
            "- Suggested data models (entity names and key fields — no code)\n"
            "- Core API surface (endpoint names and actions — no code)\n"
            "- Delivery milestones (Phase 1, 2, … with scoped deliverables)\n"
            "- File-by-file checklist for the first implementation phase\n\n"
    ...
    "market_researcher": Task(
        ...
        description=(
            ...
            "GROUNDING RULES (mandatory):\n"
            "- Base every claim ONLY on information present in the requirements and CEO Planner "
            "context above.\n"
            "- Do NOT invent statistics, assume unrelated industries, or drift off-topic.\n"
            "- If information is missing, list it as an assumption or open question.\n\n"
    ...
    "customer_support_feedback_analyst": Task(
        ...
        description=(
            ...
            "Original requirements:\n---\n{requirements}\n---\n\n"
            "GROUNDING RULES (mandatory):\n"
            "- Infer pain points from the requirements only; do NOT assume unrelated scenarios.\n"
            "- Do NOT invent support data or drift into unrelated domains.\n\n"
    ...
    "product_manager": Task(
        ...
        description=(
            ...
            "---\n{requirements}\n---\n\n"
            "GROUNDING RULES (mandatory):\n"
            "- Use ONLY the information in the requirements and prior planning context.\n"
            "- Do NOT invent features, assume unrelated industries, or hallucinate use-cases.\n"
            "- List every ambiguity explicitly in the Open Questions section.\n"
            ...
            "- Delivery milestones (Phase 1, 2, … with scoped deliverables)\n"
            "- File-by-file checklist for the first implementation phase\n\n"
            "Include a final strategy package suitable for user approval before build work "
            "starts. End with an explicit handoff note for the Compliance & Privacy Specialist "
    ...
    "compliance_privacy_specialist": Task(
        ...
        description=(
            ...
            "Original requirements:\n---\n{requirements}\n---\n\n"
            "GROUNDING RULES (mandatory):\n"
            "- Base all regulatory scope assumptions strictly on the project domain described "
            "in the requirements above.\n"
            "- Do NOT assume regulations from unrelated industries.\n"
            "- If the applicable regulatory framework is unclear, state it as an assumption and "
            "list it as an open question.\n"
            "- Do NOT invent data-handling requirements that are not implied by the project.\n\n"
